...
template <class NodeDescriptor>
void printTree(NodeDescriptor root, ostream & out = std::cout)
{
	...
	vector<string> output(print_matrix_height);
...
namespace private_print_functions
{
	...
	template <class NodeDescriptor>
	void printSubtree(NodeDescriptor croot, vector<string> & output, int left, int top, int curr_width)
	{
